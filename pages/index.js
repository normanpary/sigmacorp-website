      ...
      */}
        ...
        <div className='container relative mb-10 mx-auto max-w-[60%] grid grid-cols-4 gap-6 -mt-32 z-10'>
          ...
          <div className='transition bg-azul opacity-90 hover:bg-rosa hover:-translate-y-6  text-white px-10 py-8 rounded-xl flex flex-col items-center'>
            <div className='min-h-[80px] flex flex-col-reverse'>
              <img className='relative inset-x-0 bottom-0' src={"static/images/home/innovacion.png"} />
            </div>
          ...
          <div className='transition bg-azul opacity-90 hover:bg-rosa hover:-translate-y-6  text-white px-10 py-8 rounded-xl flex flex-col items-center'>
            ...
            <div className='text-center pt-4 text-sm'>
              Por su constante crecimiento adquirió una moderna infraestructura que cuenta con más de 15.000 m2.
            </div>
          </div>
          ...
          <div className='transition bg-azul opacity-90 hover:bg-rosa hover:-translate-y-6  text-white px-10 py-8 rounded-xl flex flex-col items-center'>
            ...
            <div className='text-center pt-4 text-sm'>
              Se tiene proyectado duplicar la producción actual e incursionar  en las áreas de Cosmética y Veterinaria.
            </div>
          </div>
      ...
      <div className='bg-gray-200 bg-fondo bg-no-repeat bg-left-top'>
        <div className=" container mx-auto p-10 pt-20 mt-8">
          ...
          >
            <div>
              <p className="font-extrabold text-gray-500 text-center text-lg">{t('home:nuestro_blog')}</p>
            </div>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 100, }}
              ...
              <div className="transition hover:-translate-y-3 hover:shadow-lg">
                  <div className="h-auto  bg-white  rounded-md">
                    ...
                    <div className="relative p-4 w-auto h-54">
                      ...
                      <p className="mt-5 capitalize line-clamp-2 text-xl font-black">DONACIÓN DE ALIMENTOS A “MANZANA ROJA”</p>
                      <p className="text-gray-500 text-base line-clamp-3 mt-2">La Manzana Roja es el primer banco de alimentos en Bolivia y funciona desde junio del 2017 a partir de una serie de investigaciones que pusieron en evidencia la necesidad de implementar un sistema de rescate y redistribución de alimentos hacia quienes más lo necesitan. </p>
                ...
                <div className="transition hover:-translate-y-3 hover:shadow-lg">
                  <div className="h-auto  bg-white  rounded-md">
                    ...
                    <div className="relative p-4 w-auto h-54">
                      ...
                      <p className="h-16 mt-5 capitalize line-clamp-2 text-xl font-black">APOYO A LA POLICÍA NACIONAL</p>
                      <p className="h-16 text-gray-500 text-base line-clamp-3 mt-2">Realizamos donación de productos de bioseguridad para nuestra Policía Nacional. </p>
                      <p className="pb-0 pt-4 text-base underline font-bold text-blue-800 mb-4">
                        {t('home:leer_mas')}
                      </p>
                    </div>
                ...
                <div className="transition hover:-translate-y-3 hover:shadow-lg">
                  <div className="h-auto  bg-white  rounded-md">
                    ...
                    <div className="relative p-4 w-auto h-54">
                      ...
                      <p className="mt-5 capitalize line-clamp-2 text-xl font-black">DONACIONES BRIGADAS DE RASTRILLAJE COCHABAMBA”</p>
                      <p className="text-gray-500 text-base line-clamp-3 mt-2">Realizamos donación de insumos de bioseguridad y alimentos para las brigadas de rastrillaje COVID-19 en la ciudad de Cochabamba</p>
                      <p className="pb-0 pt-4 text-base underline font-bold text-blue-800 mb-4">
                        {t('home:leer_mas')}
                      </p>
                    </div>
