import { items_card, items_social } from '@/data/homepage'
import ItemCard from '@/components/homepage/ItemCard'
import ItemSocial from '@/components/homepage/ItemSocial'
      ...
      <div className="bg-gray-200 bg-fondo bg-no-repeat bg-left-top p-8 mt-8">
        ...
        <div className="flex justify-center p-8">
          <div className="grid grid-cols-3 ">
            {items_social.map((item, index) => (
              <ItemSocial item={item} key={index} />
            ))}
          </div>
        </div>
      </div>
